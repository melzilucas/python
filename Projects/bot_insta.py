...
class Bot(WebBot):
    def action(self, execution=None):
        ...
        self.headless = False
        # WebDriver path
        self.driver_path = r"/Users/lucaseduardomelzi/Downloads/BotCity_Studio_macos_2.16.5/botwebinsta/botwebinsta/chromedriver"
        # website.
        ...
        try:
            ...
            botao_avancar = self.find_element(selector='/html/body/div[2]/div/div/div/div[2]/div/div/div[1]/div/div[''3]/div/div/div/div/div[2]/div/div/div/div[1]/div/div/div[''3]/div/button', by=By.XPATH)
            botao_avancar.click()
            self.wait(3000)
